...
classifier = cv2.CascadeClassifier('C:/Users/Harsita/Desktop/Face Recognition/Face Recognition/haarcascade_frontalface_default.xml')

model = load_model("C:/Users/Harsita/Desktop/Face Recognition/Face Recognition/final_model.h5")

URL = 'http://192.168.1.105:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Aarav', 'Harsita', 'Maaa', 'Mama', 'Papaa']
    return labels[pred]
